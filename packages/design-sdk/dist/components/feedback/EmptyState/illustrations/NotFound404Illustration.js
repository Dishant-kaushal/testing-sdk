...
import { forwardRef as C, useId as f } from "react";
import { cn as n } from "../../../../utils/cn.js";
const u = C(
  ({ size: t = 120, className: l }, o) => {
    const s = 131 * t / 120, a = f(), e = `fds-404-mask-${a}`, d = `fds-404-beam-gradient-${a}`;
    return /* @__PURE__ */ i(
      "svg",
      {
        ref: o,
        ...
        viewBox: "0 0 131 120",
        fill: "none",
        className: n("fds-illustration", l),
        "aria-hidden": "true",
        focusable: "false",
        children: [
          /* @__PURE__ */ r(
          ...
          /* @__PURE__ */ r("mask", { id: e, style: { maskType: "alpha" }, maskUnits: "userSpaceOnUse", x: "24", y: "36", width: "80", height: "61", children: /* @__PURE__ */ r(
            "path",
            {
          ...
          /* @__PURE__ */ r("g", { mask: `url(#${e})`, children: /* @__PURE__ */ r(
            "path",
            {
              opacity: "0.22",
              d: "M72.249 36.344L52.6382 36.1372L24.7099 88.0837L103.098 96.3275L94.3633 43.3766L72.249 36.344Z",
          ...
          /* @__PURE__ */ r("defs", { children: /* @__PURE__ */ i(
            "linearGradient",
            {
              id: d,
              x1: "63.904",
              ...
              children: [
                /* @__PURE__ */ r("stop", { stopColor: "var(--background-surface-intense)" }),
                /* @__PURE__ */ r("stop", { offset: "1", stopColor: "var(--background-surface-intense)", stopOpacity: "0" })
              ]
            }
          ) })
        ]
...
u.displayName = "NotFound404Illustration";
export {
  u as NotFound404Illustration
};
