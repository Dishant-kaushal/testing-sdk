import { generateLinearEasing as R } from "../../animators/waapi/utils/linear.js";
import { millisecondsToSeconds as b, secondsToMilliseconds as A } from "../../../utils/time-conversion.js";
import { calcGeneratorVelocity as w } from "../utils/velocity.js";
import { findSpring as B, calcAngularFreq as K } from "./find.js";
import { calcGeneratorDuration as V, maxGeneratorDuration as j } from "../utils/calc-duration.js";
import { clamp as E } from "../../../utils/clamp.js";
...
function P(t) {
  ...
  if (!x(t, L) && x(t, I))
    if (t.visualDuration) {
      const s = t.visualDuration, u = 2 * Math.PI / (s * 1.2), m = u * u, g = 2 * E(0.05, 1, 1 - t.bounce) * Math.sqrt(m);
      r = {
        ...r,
        mass: a.mass,
        stiffness: m,
...
function U(t = a.visualDuration, r = a.bounce) {
  ...
  const y = {
    ...
    toString: () => {
      const e = Math.min(V(y), j), n = R((l) => y.next(e * l).value, e, 30);
      return e + "ms " + n;
    }
  };
  return y;
