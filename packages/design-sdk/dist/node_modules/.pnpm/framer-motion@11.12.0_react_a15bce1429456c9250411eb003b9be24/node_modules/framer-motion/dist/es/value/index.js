import { SubscriptionManager as o } from "../utils/subscription-manager.js";
import { velocityPerSecond as c } from "../utils/velocity-per-second.js";
import { warnOnce as u } from "../utils/warn-once.js";
...
class d {
   ...
   */
  constructor(t, e = {}) {
    this.version = "11.12.0", this.canTrackVelocity = null, this.events = {}, this.updateAndNotify = (i, a = !0) => {
      const h = n.now();
      this.updatedAt !== h && this.setPrevFrameValue(), this.prev = this.current, this.setCurrent(i), this.current !== this.prev && this.events.change && this.events.change.notify(this.current), a && this.events.renderRequest && this.events.renderRequest.notify(this.current);
