...
export declare function RadioGroup({ label, name, value, onChange, size, isDisabled, children, className, orientation, ...rest }: RadioGroupProps): import("react/jsx-runtime").JSX.Element;
